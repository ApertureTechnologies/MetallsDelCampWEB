...
export const gerencias = {
  ...
  aldaia: {
    ...
    coordinacion: {
      id: "coordinador-general-planta-logistica",
      nombre: "Mario Sánchez",
      puesto: "Coordinador General de Planta y Logística",
      foto: "/brand/team/coordinador-general.jpg"
    },
    equipos: {
      coscollar: {
        planificador: {
      ...
      plantaFiltros: {
        responsable: {
          id: "responsable-planta-filtros",
          nombre: "Tomás Tapia",
          puesto: "Responsable de Planta",
          ubicacion: "Planta de Filtros",
          foto: "/brand/team/responsable-planta-filtros.jpg"
        }
      }
    }
  },
  ...
  elRomeral: {
    ...
    equipos: {
      plantaResiduos: {
        jefa: {
          id: "jefa-administrativa-planta-residuos-romeral",
          nombre: "María Concepción Fernández",
          puesto: "Jefa Administrativa",
          ubicacion: "Planta de Residuos",
          foto: "/brand/team/jefa-admin-planta-residuos-romeral.jpg"
        },
        responsable: {
